...
<div class="row">    
    ...
    <div class="col-md-5">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><?= number_format($marginTotal+$gain[0]['margins']+$dividen[0]['amounts'],2,".",",") < 0 ? 'Loss ' :'Profit '?>(Rp.) : <?= number_format($marginTotal+$gain[0]['margins']+$dividen[0]['amounts'],2,".",","); ?></h3>
