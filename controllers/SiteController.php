...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $posts = MuvtiPost::find()->where("status='Active' AND id !=6")->limit(3)->orderBy(["date_created"=> SORT_DESC])->all();
    ...
    public function actionBlog()
    {
        ...
        $articles = MuvtiPost::find()->where("status='Active' AND id != 6")->limit(5)->orderBy(["date_created"=> SORT_DESC])->all();
